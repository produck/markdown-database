...
import { SubConstructor as M_SubConstructor } from '@produck/es-abstract-member-parser-sub-constructor';
...
export default Abstract(
	...
	...[
		...
		Abstract.Static({
			[_S.CONSTRUCTOR.NODE]: M_SubConstructor(AbstractNode),
			[_S.CONSTRUCTOR.PROVIDER]: M_SubConstructor(AbstractProvider),
		}),
	],
);
